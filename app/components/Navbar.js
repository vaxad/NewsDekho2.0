...
<nav className=" bg-black">
  ...
  <div className="block items-center">
      ...
      <span className="self-center lg:text-2xl text-lg font-semibold whitespace-nowrap dark:text-white">NewsDekho2.0</span>
  </div>
  <div className={`flex ${show?'lg:w-2/3 w-3/5':''} md:order-2 gap-5 transition-all`}>
    {show&&<div className="relative w-full md:block">
      ...
      <input value={searchTerm} onChange={(e)=>setSearchTerm(e.target.value)}  type="text" id="search-navbar" className="flex w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..."/>
      </form>
    </div> }
    <button onClick={()=>{setshow(!show)}} type="button" data-collapse-toggle="navbar-search" aria-controls="navbar-search" aria-expanded="false" className=" text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700  rounded-lg text-sm p-2.5 mr-1" >
      {show?<svg className="w-5 h-5 text-gray-500 dark:text-gray-400" aria-hidden="true" fill='currentColor' xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 50 50">
<path d="M 14.40625 13 L 13 14.40625 L 23.625 25 L 13 35.59375 L 14.40625 37 L 25.0625 26.40625 L 35.6875 37 L 37.09375 35.59375 L 26.46875 25 L 37.09375 14.40625 L 35.6875 13 L 25.0625 23.59375 Z"></path>
    ...
    {!show&&<button onClick={()=>{setshownav(!shownav)}} data-collapse-toggle="navbar-search" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-search" aria-expanded="false">
